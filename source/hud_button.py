...
class HUD_button(pygame.sprite.Sprite):
    ...
    def __init__(self, num, img, parent=0, name="null"):
        super().__init__()
        ...
        if num < 20:
            ...
            self.rect.y = windowSize - (1 + parent) * HUD_size + HUD_margin
            ...
            self.rect.x = windowSize - shift_by_element + shift_by_element * int((20 - num) / 2)
            self.rect.y = windowSize - HUD_size + HUD_margin + (num % 2) * (HUD_size_button / 2 + HUD_margin)
